...
const songs = [
    ...
    {
        id: 19,
        songName: `Eh Munde Pagal Ne Saage <br>
        <div class="subtitle">Ap Dhillion, Gurinder Gill, Shinda Kahlon  </div>`,
        poster: 'img/19.jpg'
    },
    {
        id: 20,
...
music.addEventListener('timeupdate', ()=>{
    ...
    let proggresBar = parseInt((music_curr / music_dur) * 100);
    seek.value = proggresBar;
